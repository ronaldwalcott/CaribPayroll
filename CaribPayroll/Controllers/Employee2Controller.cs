...
namespace CaribPayroll.Controllers
{
    public class Employee2Controller : Controller
    {
        ...
        public Employee2Controller(ApplicationDbContext context, UserManager<ApplicationUser> userManager, ILogger<EmployeeController> logger, IDateTimeUtc dateTimeUtc)
        {
            _context = context;
