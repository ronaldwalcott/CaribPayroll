...
namespace CaribPayroll.Data.Migrations
{
    ...
    [Migration("20200206041345_UpdateEmployeeEntity4")]
    partial class UpdateEmployeeEntity4
    {
            ...
            modelBuilder.Entity("CaribPayroll.Models.DeductionCalculationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Action = "A",
                            CalculationType = "F",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 2, 6, 0, 13, 45, 5, DateTimeKind.Unspecified).AddTicks(5532), new TimeSpan(0, -4, 0, 0, 0)),
                            Description = "Fixed",
                            ModifiedDate = new DateTimeOffset(new DateTime(2020, 2, 6, 0, 13, 45, 8, DateTimeKind.Unspecified).AddTicks(5374), new TimeSpan(0, -4, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            Action = "A",
                            CalculationType = "P",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 2, 6, 0, 13, 45, 8, DateTimeKind.Unspecified).AddTicks(6119), new TimeSpan(0, -4, 0, 0, 0)),
                            Description = "Percent",
                            ModifiedDate = new DateTimeOffset(new DateTime(2020, 2, 6, 0, 13, 45, 8, DateTimeKind.Unspecified).AddTicks(6140), new TimeSpan(0, -4, 0, 0, 0))
                        },
                        new
                        {
                            Id = 3,
                            Action = "A",
                            CalculationType = "R",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 2, 6, 0, 13, 45, 8, DateTimeKind.Unspecified).AddTicks(6149), new TimeSpan(0, -4, 0, 0, 0)),
                            Description = "Range",
                            ModifiedDate = new DateTimeOffset(new DateTime(2020, 2, 6, 0, 13, 45, 8, DateTimeKind.Unspecified).AddTicks(6151), new TimeSpan(0, -4, 0, 0, 0))
                        },
                        new
                        {
                            Id = 4,
                            Action = "A",
                            CalculationType = "S",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 2, 6, 0, 13, 45, 8, DateTimeKind.Unspecified).AddTicks(6155), new TimeSpan(0, -4, 0, 0, 0)),
                            Description = "Scale",
                            ModifiedDate = new DateTimeOffset(new DateTime(2020, 2, 6, 0, 13, 45, 8, DateTimeKind.Unspecified).AddTicks(6156), new TimeSpan(0, -4, 0, 0, 0))
                        },
                        new
                        {
                            Id = 5,
                            Action = "A",
                            CalculationType = "B",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 2, 6, 0, 13, 45, 8, DateTimeKind.Unspecified).AddTicks(6159), new TimeSpan(0, -4, 0, 0, 0)),
                            Description = "Reducing Balance",
                            ModifiedDate = new DateTimeOffset(new DateTime(2020, 2, 6, 0, 13, 45, 8, DateTimeKind.Unspecified).AddTicks(6161), new TimeSpan(0, -4, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("CaribPayroll.Models.PaymentPeriod", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Action = "A",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 2, 6, 0, 13, 45, 10, DateTimeKind.Unspecified).AddTicks(635), new TimeSpan(0, -4, 0, 0, 0)),
                            Description = "Monthly",
                            ModifiedDate = new DateTimeOffset(new DateTime(2020, 2, 6, 0, 13, 45, 10, DateTimeKind.Unspecified).AddTicks(678), new TimeSpan(0, -4, 0, 0, 0)),
                            PaymentCode = "M"
                        },
                        new
                        {
                            Id = 2,
                            Action = "A",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 2, 6, 0, 13, 45, 10, DateTimeKind.Unspecified).AddTicks(733), new TimeSpan(0, -4, 0, 0, 0)),
                            Description = "Weekly",
                            ModifiedDate = new DateTimeOffset(new DateTime(2020, 2, 6, 0, 13, 45, 10, DateTimeKind.Unspecified).AddTicks(736), new TimeSpan(0, -4, 0, 0, 0)),
                            PaymentCode = "W"
                        });
                });
