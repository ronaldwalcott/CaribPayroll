...
namespace CaribPayroll.Data.Migrations
{
    ...
    [Migration("20200130221215_CreateEmployeeEntity")]
            ...
            modelBuilder.Entity("CaribPayroll.Models.DeductionCalculationType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Action = "A",
                            CalculationType = "F",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 1, 30, 18, 12, 15, 415, DateTimeKind.Unspecified).AddTicks(3579), new TimeSpan(0, -4, 0, 0, 0)),
                            Description = "Fixed",
                            ModifiedDate = new DateTimeOffset(new DateTime(2020, 1, 30, 18, 12, 15, 418, DateTimeKind.Unspecified).AddTicks(1412), new TimeSpan(0, -4, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            Action = "A",
                            CalculationType = "P",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 1, 30, 18, 12, 15, 418, DateTimeKind.Unspecified).AddTicks(2194), new TimeSpan(0, -4, 0, 0, 0)),
                            Description = "Fixed",
                            ModifiedDate = new DateTimeOffset(new DateTime(2020, 1, 30, 18, 12, 15, 418, DateTimeKind.Unspecified).AddTicks(2212), new TimeSpan(0, -4, 0, 0, 0))
                        },
                        new
                        {
                            Id = 3,
                            Action = "A",
                            CalculationType = "R",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 1, 30, 18, 12, 15, 418, DateTimeKind.Unspecified).AddTicks(2227), new TimeSpan(0, -4, 0, 0, 0)),
                            Description = "Range",
                            ModifiedDate = new DateTimeOffset(new DateTime(2020, 1, 30, 18, 12, 15, 418, DateTimeKind.Unspecified).AddTicks(2228), new TimeSpan(0, -4, 0, 0, 0))
                        },
                        new
                        {
                            Id = 4,
                            Action = "A",
                            CalculationType = "S",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 1, 30, 18, 12, 15, 418, DateTimeKind.Unspecified).AddTicks(2231), new TimeSpan(0, -4, 0, 0, 0)),
                            Description = "Scale",
                            ModifiedDate = new DateTimeOffset(new DateTime(2020, 1, 30, 18, 12, 15, 418, DateTimeKind.Unspecified).AddTicks(2232), new TimeSpan(0, -4, 0, 0, 0))
                        },
                        new
                        {
                            Id = 5,
                            Action = "A",
                            CalculationType = "B",
                            CreatedDate = new DateTimeOffset(new DateTime(2020, 1, 30, 18, 12, 15, 418, DateTimeKind.Unspecified).AddTicks(2234), new TimeSpan(0, -4, 0, 0, 0)),
                            Description = "Reducing Balance",
                            ModifiedDate = new DateTimeOffset(new DateTime(2020, 1, 30, 18, 12, 15, 418, DateTimeKind.Unspecified).AddTicks(2236), new TimeSpan(0, -4, 0, 0, 0))
                        });
                });
